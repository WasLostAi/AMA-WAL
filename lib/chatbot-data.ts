export const chatbotData = {
  personal: {
    ...
    nickname: "Mike",
    age: 43, // Keeping previous age as it aligns with experience
    location: "New Jersey",
    background:
      "Born in New Jersey with family from Bermuda. Developed Black Hat SEO Software until an autistic breakdown approximately 10 years ago. In 2019, began working with generative AI and has been rehabilitating since then.",
    education:
      "Associate's degrees in Computer Systems Network Administration (2005) and Psychology (2006) from Mercer County Community College, and a Bachelor's degree in Interactive Media Design from The Art Institute (2008–2010).",
    ...
    personalStatement:
      "After a successful independent career and a period focused on personal growth, I am eager to return to a collaborative, high-impact environment. My experience has taught me the importance of clear communication, structure, teamwork, and shared vision. I am passionate about building innovative products and leading others, and I thrive when working alongside talented colleagues to achieve ambitious goals.",
  },
  professional: {
    currentRole:
      "Founder & Lead Developer - WasLost.Ai (2022-Present). Pioneering developer specializing in software product design, AI Agentic Solutions, and Tokenized Web3 Workflows.",
    responsibilities: [
  ...
  company: {
    ...
    product: "WasLost.Ai",
    description:
      "A comprehensive Web3-native AI agent ecosystem combining practical utility with blockchain innovation. Specializing in Ai Agentic Solutions and Tokenized Web3 Workflows, with a primary focus on Generative and Financial/Trading Apps, including Algorithmic trading.",
    projects: [
      {
