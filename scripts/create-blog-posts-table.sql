...
-- Create a text search index on title and content for potential future search functionality
-- This requires the 'pg_trgm' extension for good performance.
-- CREATE EXTENSION IF NOT EXISTS pg_trgm;
-- CREATE INDEX IF NOT EXISTS idx_blog_posts_search ON blog_posts USING GIN (title gin_trgm_ops, content gin_trgm_ops);
